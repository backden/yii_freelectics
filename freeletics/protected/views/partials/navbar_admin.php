...
<div id="navbar-container">
  <div class="navbar-collapse collapse" id="navbar-main">
    <ul class="nav navbar-nav">
      ...
      <li class="">
        <a class="" href="#sub-resource-menus" id="btn-resource" onclick="return false;">
          <i class="fa fa-fw fa-gavel"></i>
          <?php echo Yii::t('app', "Resources"); ?>
  ...
  <div class="sub-navbar">
    <div class="navbar-collapse navbar-sub-container nav-closed" id="sub-resource-menus">
      <ul class="nav navbar-nav">
        <li class="dropdown">
          <a class="dropdown-toggle" href="#" id="btn-exercises" data-toggle="dropdown"><?php echo Yii::t('app', "Exercises"); ?> <span class="caret"></span></a>
