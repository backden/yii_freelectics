                ...
                <div class="row form-group">
                  ...
                  <div class="col-lg-9 col-sm-12">
                    <div class="row">
                      ...
                      <div class="col-lg-12 col-sm-12">
                        <input type="text" class="form-control" value="<?php echo $model->birthday; ?>" id="date-picker" data-date-format="YYYY/MM/DD" readonly="true" style="display: inline-block; width: 90%;">
                        <button class="btn btn-sm btn-datepicker-open" onclick="return false;"><i class="fa fa-calendar-o"></i></button>
                      </div>
                    </div>
                  </div>
                </div>
