    ...
    <div id="navbar-container">
      <div class="navbar-collapse collapse" id="navbar-main">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li><a href="/cake/home/?admin=1" class="btn btn-primary btn-sm"><?php echo Yii::t("app", "Get your Coach"); ?></a></li>
      ...
      <div class="sub-navbar">
        ...
        <div class="navbar-collapse navbar-sub-container nav-closed" id="sub-community-menus">
          <ul class="nav navbar-nav">
            ...
            <li><a class="" href="/cake/userinfo/?admin=1" id="download"><i class="fa fa-group"></i>&nbsp;<?php echo Yii::t("app", "Group"); ?></span></a></li>
          </ul>
        </div>
        <div class="navbar-collapse navbar-sub-container nav-closed" id="option-menus">
          <ul class="nav navbar-nav">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="" href="/cake/home/userinfo/?admin=1" id="download"><i class="fa fa-user"></i>&nbsp;<?php echo Yii::t("app", "Statics"); ?></span></a></li>
