                ...
                <div class="col-lg-12">
                  <div class="list-group">
                    <?php foreach ($exe['exercisesAll'] as $id => $e) { ?>
                      <a href="<?php echo Yii::app()->createUrl('/user/training/', array("category" => $exe['id'], 'exercise' => $e)); ?>" class="list-group-item <?php echo in_array($e, $myExercises) ? '' : 'disabled' ?>">
                ...
                <?php foreach ($exe['exercisesAll'] as $id => $e) { ?>
                  <div class="col-lg-9" id="">
                    <div class="list-group">
                      ...
                      <a href="<?php echo Yii::app()->createUrl('/user/training/', array("category" => $exe['id'], 'exercise' => $exeModel->id)); ?>" class="list-group-item <?php echo in_array($exeModel->id, $myExercises) ? '' : 'disabled' ?>">
                          <?php echo Yii::t("app", $exeModel->name); ?>
                        </a>
                      <?php } ?>
                    </div>
