...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('like_total')); ?>:</b>
	<?php echo CHtml::encode($data->like_total); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('extra_like')); ?>:</b>
	<?php echo CHtml::encode($data->extra_like); ?>
	<br />
