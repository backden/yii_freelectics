...
class BlogArticleController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['BlogArticle'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('BlogArticle');
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['BlogArticle']))
			$model->attributes=$_GET['BlogArticle'];
	 ...
	 * @param BlogArticle $model the model to be validated
	 */
